...
import { HttpBadRequestError } from '@src/module.api/exceptions'
...
describe('controller.test()', () => {
  ...
  it('should throw HttpBadRequestError due to invalid txn', async () => {
  ...
  it('should throw HttpBadRequestError due to high fees', async () => {
